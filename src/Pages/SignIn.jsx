    ...
    return (
      ...
      <div className="w-full max-w-5xl bg-[#edebe4] rounded-3xl overflow-hidden shadow-lg flex flex-col lg:flex-row ">
        ...
        <div className="lg:w-1/2 p-10 lg:mt-16">
          <h2 className="text-4xl  font-bold mb-2 rancho">Sign In Your Account</h2>
          <p className="text-sm mb-6 text-black raleway">
            Already have an account? <Link to={'/signUp'} className="text-blue-500 hover:underline">Register</Link>
          </p>
          ...
          <form onSubmit={signInUserHandle} className="space-y-4">
            ...
            <div className='relative'>
                ...
                <button type='button' className='absolute top-2 right-4'></button>
            </div>

            <label className="inline-flex items-center mt-2">
              <input type="checkbox" name='remember' className="form-checkbox text-purple-500" />
              <span className="ml-2 text-sm text-black">Remember Me</span>
            </label>

            <input type="submit" value="Login Now" className="w-full bg-[#382828] hover:bg-[#382828] text-white font-semibold py-3 rounded-md mt-4 cursor-pointer raleway" />
            <ToastContainer />
          </form>

          <div className="mt-2 text-center text-gray-400 text-sm">Or Login with</div> 

          <div className="flex justify-center gap-4 mt-4">
            <button onClick={signInwithGoogle} className="flex items-center gap-2 bg-white text-black px-4 py-2 rounded-md hover:bg-gray-200">

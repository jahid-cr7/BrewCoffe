  ...
  return (
    <div className="lg:flex items-center bg-[#ECEAE3] py-10 justify-between lg:px-32 md:px-10 mt-12">
      <div className="lg:px-16 px-5">
        ...
        <p className="raleway text-[20px] flex items-center gap-4 mb-1">
      ...
      <div className="px-5 mt-4">
        ...
        <form action="">
          <input
            ...
            name="name"
            placeholder="Name"
            className="lg:w-[400px] w-[300px] px-4 py-2 mb-3 mt-3 bg-white rounded focus:outline-none "
          />
          <br />
          <input
            type="text"
            ...
            name="email"
            placeholder="Email"
            className="lg:w-[400px] w-[300px] px-4 py-2 mb-3 bg-white rounded focus:outline-none" />
          <br />
          <textarea
            type="text"
            id="message"
